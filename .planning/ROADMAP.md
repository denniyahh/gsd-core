...
This MVP delivers a narrowly scoped state-integrity repair: planning a phase retains the authoritative activity metadata already recorded in `STATE.md`, with a command-level regression that proves the final serialized state remains correct.
...
- [ ] **Phase 1: Planned-Phase State Integrity** - Preserve authoritative activity metadata during planned-phase updates and prove it against the written `STATE.md` artifact.
...
|-------|----------------|--------|-----------|
| 1. Planned-Phase State Integrity | 0/TBD | Not started | - |
